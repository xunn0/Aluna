...
if (isset($_SESSION['teacherLoggedIn']) && $_SESSION['teacherLoggedIn'] === true) {
    // Redirect to the teacher homepage
...
<body id="signin">
    <div class="grid-container">
        ...
        <div class="item3">
            <div id="frm">
                <h1>Sign in</h1>
                <form action="teacher_authentication.php" method="POST" name="myForm" onsubmit="return validateForm()" required>
                    <p>
