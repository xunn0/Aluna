function printTable() {
    ...
    var actionsColumn = clonedTable.querySelector('th:nth-child(9), td:nth-child(9)');
    if (actionsColumn) {
    ...
    var htmlContent = `
      ...
      <head>
        ...
        <style>
          ...
          .table-class th:nth-child(9),
          .table-class td:nth-child(9) {
            display: none;
          }
  
          /* Center the "Students Report" text */
          .report-heading {
            text-align: center;
            font-size: 16px;
            margin-top: 20px;
      ...
      <body>
        <h2 class="report-heading">Students Report</h2>
