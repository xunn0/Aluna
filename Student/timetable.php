...
// Retrieve the classes the current student is attending
$classesStmt = $con->prepare("SELECT class.* FROM class JOIN class_student ON class.class_id = class_student.class_id WHERE class_student.student_id = ?");
$classesStmt->bind_param("i", $studentId);
$classesStmt->execute();
...
<body>
    ...
    <h3 id="teach">Timetable for <?php echo $studentName; ?></h3>
