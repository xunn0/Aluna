...
<body>
  ...
  <div class="container">
    <div class="header_wrap">
      ...
      <button class="add" id="btnOpenForm2">Add marks</button>
        ...
        <tbody>
          ...
          ?>
              <tr>
                ...
                <td>
                  <a href="#" onclick="openUpdateForm(<?php echo $row['mark_id']; ?>, '<?php echo $row['test_name']; ?>', '<?php echo $row['marks_obtained']; ?>', '<?php echo $row['student_id']; ?>', '<?php echo $row['class_id']; ?>', '<?php echo $row['teacher_id']; ?>'); return false;">
                    <i class="fa-regular fa-pen-to-square"></i>
                  </a>
                  <a href="delete-mark.php?mark_id=<?php echo $row['mark_id']; ?>" onclick="return confirmDelete()">
